...
export const DEMO_GIVEAWAY: Giveaway = {
  ...
  description:
    "В честь запуска Freespin разыгрываем новый iPhone 16 Pro среди подписчиков нашего канала. Три простых шага — и ты в игре!",
  slug: "demo-iphone",
  status: "active",
  tier: "premium",
  entrySource: "form",
...
export const DEMO_GIVEAWAY_INSTAGRAM: Giveaway = {
  ...
  description:
    "Разыгрываем пару кроссовок среди тех, кто оставит комментарий под этим постом с хэштегом #freespin. Просто, честно, без формы регистрации.",
  ...
  instagramSource: {
    ...
    caption: "Розыгрыш кроссовок! Комментируй с #freespin, чтобы участвовать 🎁",
...
export const DEMO_GIVEAWAY_TELEGRAM: Giveaway = {
  ...
  telegramSource: {
    channelUsername: "freespin_giveaways",
    postUrl: "https://t.me/freespin_giveaways/482",
    postId: "482",
